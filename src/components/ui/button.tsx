  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 select-none cursor-pointer',
  {
    variants: {
      variant: {
        ...
        hud: 'bg-background/80 hover:bg-accent text-foreground backdrop-blur-md border border-border/60 shadow-sm transition-all active:scale-95',
        'hud-active':
          'bg-primary/15 text-primary border border-primary/40 backdrop-blur-md shadow-sm font-semibold',
      },
      size: {
